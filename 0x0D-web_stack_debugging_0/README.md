...
```bash
vagrant@vagrant:~$ docker pull holbertonschool/265-0
vagrant@vagrant:~$ curl 0:8080
Hello Holberton
vagrant@vagrant:~$
```
...
```bash
vagrant@vagrant:~$ cat 0-give_me_a_page | docker exec -i vigilant_tesla /bin/bash
```
## Resources
- [What is docker](https://www.zdnet.com/article/what-is-docker-and-why-is-it-so-darn-popular/)